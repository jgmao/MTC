...
vector<Point3i> QGrid<T,cn>::BoundaryMatching(QNode<T,cn>& qNode, MatchingMethod matching_method, double matching_thrd)
{
  ...
  if (matching_method == MatchingMethod::MATCHING_OPENCV)
  {
      ...
      tarLeft.convertTo(flLeft,CV_32F);
        ...
        else if (matching_method == MatchingMethod::MATCHING_MSE || matching_method ==  MatchingMethod::MATCHING_SAD|| matching_method == MatchingMethod::MATCHING_MSE_CONSTRAINT)
        {
